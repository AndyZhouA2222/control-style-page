...
const NODES = [
  { id:"overview",  label:"Overview",         subtitle:"THE OLDEST HOUSE",   x:50, y:12, symbol:"\u25C8",
    ...
    desc:"", details:[] },
  { id:"pillars",   label:"Pillars",          subtitle:"STRUCTURAL PILLARS", x:15, y:38, symbol:"\u2551",
    image:"images/pillars.png", aspect:"portrait",
    desc:"", details:[] },
  { id:"ceiling",   label:"Skylight",         subtitle:"ASTRAL SKYLIGHT",    x:50, y:34, symbol:"\u25A1",
    image:"images/ceiling.png", aspect:"landscape",
    desc:"", details:[] },
  ...
  { id:"entrance",  label:"Threshold",        subtitle:"THRESHOLD",          x:50, y:88, symbol:"\u2293",
    image:"images/entrance.png", aspect:"portrait",
    desc:"", details:[] },
];
