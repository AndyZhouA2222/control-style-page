...
const NODES = [
  { id:"overview",  label:"Overview",         subtitle:"THE OLDEST HOUSE",   x:50, y:12, symbol:"\u25C8",
    image:"images/overview.png", aspect:"portrait",
    desc:"", details:[] },
  { id:"pillars",   label:"THE PILLARS",          subtitle:"STRUCTURAL PILLARS", x:15, y:38, symbol:"\u2551",
    image:"images/pillars.png", aspect:"portrait",
    desc:"", details:[] },
  { id:"ceiling",   label:"THE RECEIVER",         subtitle:"ASTRAL SKYLIGHT",    x:50, y:34, symbol:"\u25A1",
    image:"images/receiver.png", aspect:"landscape",
    desc:"", details:[] },
  { id:"floor",     label:"THE SEAL",     subtitle:"FLOOR SIGILS",       x:85, y:38, symbol:"\u25C7",
  ...
  { id:"walls",     label:"THE WALL",          subtitle:"CONTAINMENT WALLS",  x:65, y:62, symbol:"\u2261",
    ...
    desc:"", details:[] },
  { id:"entrance",  label:"THE COURT",        subtitle:"THRESHOLD",          x:50, y:88, symbol:"\u2293",
